...
export class FetchNFTClient {
  ...
  public getCollectiblesFromOpenSea = async (
    wallets: string[]
  ): Promise<CollectibleState> =>
    wallets.length ? await this.openSeaClient.getAllCollectibles(wallets) : {};

  public getCollectiblesFromOpenSeaByContractAddressesAndTokenIds = async (
    wallet: string,
    contractAddresses: string[],
    tokenIds: string[]
  ): Promise<Collectible[]> =>
    wallet
      ? await this.openSeaClient.getCollectiblesForWalletByContractAddressesAndTokenIds(
          wallet,
          contractAddresses,
          tokenIds
        )
  ...
  public getEthereumCollection = async (
  ...
  public getCollectionsFromNftPort = async (
    wallet: string,
    limit: number,
    continuation: string
  ...
  public getAssetDetailFromOpenSea = async (
    assetContractAddress: string,
    tokenId: string
  ): Promise<Collectible> => {
    return await this.openSeaClient.getAssetDetail(
      assetContractAddress,
      tokenId
    );
  };

  public getAssetDetailFromNftPort = async (
    assetContractAddress: string,
    tokenId: string
  ): Promise<NftPortAssetExtended> => {
    return await this.nftPortClient.getAssetDetail(
      assetContractAddress,
      tokenId
    );
  };

  public getNftsFromNftPort = async (
    wallet: string,
    ...
    return await this.nftPortClient.getNfts(
      wallet,
      contractAddress,
      limit,
      continuation,
  ...
  public getAssetOwner = async (
    ...
    return await this.nftPortClient.getAssetOwner(
      assetContractAddress,
      tokenId
    );
  };
