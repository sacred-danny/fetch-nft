      ...
      return {
        data: item?.nfts.map((nft: any) => {
          return {
            ...
            file_url: convertIpfsUrl(nft?.cached_file_url || nft?.file_url || null),
            image_url: convertIpfsUrl(nft?.cached_file_url || nft?.file_url || null),
            image_preview_url: null,
            image_thumbnail_url: null,
            image_original_url: null,
            animation_url: convertIpfsUrl(nft?.cached_animation_url || nft?.animation_url || null),
  ...
  public getAssetDetail = async (assetContractAddress: string, tokenId: string): Promise<NftPortAssetExtended> => {
    try {
      ...
      return {
        ...
        file_url: convertIpfsUrl(result.nft?.cached_file_url || result.nft?.file_url || null),
        image_url: convertIpfsUrl(result.nft?.cached_file_url || result.nft?.file_url || null),
        image_preview_url: null,
        image_thumbnail_url: null,
        image_original_url: null,
        animation_url: convertIpfsUrl(result.nft?.cached_animation_url || result.nft?.animation_url || null),
        animation_original_url: null,
